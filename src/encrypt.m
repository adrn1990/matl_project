...
if (mod(ArrayLength,3) == 1)
    CharArray=[CharArray,'  ']; %add two spaces
    ArrayLength= ArrayLength+2;
    Remainder= 2;
elseif (mod(ArrayLength,3) == 2)
    CharArray=[CharArray,' ']; %add one spaces
...
this matrix to another 3×# matrix. The transformation is effected by multiplying
...
m = randi(100,3,3); %Changed to random values
...
to put them back into a 1 × 15 array:
%}
